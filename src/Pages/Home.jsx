...
const HomePage = () => {
  const handleDownload = () => {
    ...
    link.href = '../../public/progo.apk'; // Replace this URL with your file path or URL
    link.setAttribute('download', 'progo.apk');
    ...
    <div className="home-container">
      <section className="hero-section" id="home">
        <div className="hero-content">
          <h1>PRO GO - IS THE MOST LOVED FANTASY GAME IN INDIA</h1>
          <p className="sub-text">100+ downloads daily</p>
          <div className="download-icon">
            <i className="fa fa-cloud-download" aria-hidden="true"></i>
          </div>
          <p className="description">
          PRO GO Fantasy merges the exhilaration of live sports with the excitement of strategic gameplay and competitive action.
          </p>
        ...
        <div className="hero-image-container">
          <img src={PROR} alt="Mobile Mockup" className="hero-image" />
        </div>
      </section>
      ...
      <section className="about-section" id="about">
        ...
        <div className="about-content">
          <h2>WE ARE DELIGHTED TO UNVEIL OUR EXCITING NEW DEVELOPMENT. – <span className="highlight">FANTASY SPORTS GAME PRO GO!</span></h2>
          <p>
          PRO GO offers a virtual arena where you can dive into the thrilling world of sports. Predict the outcomes of real matches and build your own teams with your favorite athletes. Success hinges on your skill and intuition!
          </p>
          <p>
      ...
      <section className="immersive-world-section">
        <div className="immersive-world-content">
          ...
          <p>
          PRO GO is a fantasy sports game that goes beyond expectations. With its breathtaking graphics, extensive customization options, robust community features, real-time updates, and a rewarding system, it delivers an unmatched gaming experience. For sports enthusiasts eager to showcase their managerial skills, PRO GO is the ultimate game. Dive into the immersive world of PRO GO and get ready to be captivated by the excitement and thrill of virtual sports management.
          </p>
        </div>
        <div className="immersive-world-image">
          <img src={PRO2} alt="Pro Go Mobile Mockup" className="pro-go-image" />
        </div>
      </section>

      {/* Pro Go Special Section */}
      <section className="wingo-special-section">
        <h2 className="section-title">WHAT MAKES PRO GO UNIQUE?</h2>
